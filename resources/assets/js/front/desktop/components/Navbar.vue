  ...
  <header class="header">
    <div class="container">
      <div class="header-inner">
        <button
          class="btn btn-link header-menu-toggle"
          type="btn"
          data-toggle="modal"
          data-target="#drawer"
        >
        ...
        <ul class="nav header-nav">
          <li class="nav-item">
            <router-link class="nav-link" :to="{name: 'home'}" exact>{{$t("header.shops")}}</router-link>
          </li>
          <li class="nav-item">
            <router-link class="nav-link" :to="{name: 'delivery'}">{{$t("header.delivery")}}</router-link>
          </li>
        </ul>
        <div
          class="header-search"
          v-if="$route.name == 'catalog' || $route.name == 'category' || $route.name == 'pp'|| $route.name == 'tp'"
        >
          <input
            class="form-control"
            @focus="show=true"
        ...
        <div class="header-controls">
          <div class="dropdown">
            <button
              class="btn btn-link header-lang-toggle dropdown-toggle"
              type="button"
              data-toggle="dropdown"
              aria-haspopup="true"
              aria-expanded="false"
            >{{locale == 'ru' ? 'Русский' : 'O`zbekcha'}}</button>
          ...
          <div class="dropdown" v-if="user.data && user.data.phone">
            <button
              class="btn btn-link header-profile-toggle"
              type="button"
              data-toggle="dropdown"
              aria-haspopup="true"
              aria-expanded="false"
            >
              ...
              <span class="text">{{$t('header.profile')}}</span>
            </button>
