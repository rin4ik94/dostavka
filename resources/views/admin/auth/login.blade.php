      ...
      <div class="card-body">
          ...
          <div class="form-group">
            <div class="input-group">
              ...
              <input id="mobile" type="mobile" class="form-control {{ $errors->has('mobile') ? 'border-danger' : '' }}" name="mobile" value="{{ old('mobile') }}" required autofocus placeholder="Mobile Number">
            </div>
        ...
        <button class="btn btn-block btn-green" type="submit">Login</button>
      </div>
    </div>
  </form>
</div>
